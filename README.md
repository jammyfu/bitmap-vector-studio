...
# 健康检查
print(client.health())  # {'status': 'ok', 'version': '1.0.0'}
```
...
**当前阶段（v1.0.0）**：桌面产品化 — Tauri 桌面应用、文件拖拽队列、原生窗口菜单、自动更新、多平台打包、键盘快捷键、桌面端预设市场和插件管理器。

**下一阶段（v1.1）**：性能优化与体验打磨 — 启动速度优化、大文件内存优化、GPU 加速预览、多语言 OCR 增强、插件热重载、批量任务断点续传。
