...
# 健康检查
print(client.health())  # {'status': 'ok', 'version': '1.1.0'}
```
...
**当前阶段（v1.1.0）**：性能优化与体验打磨 — GPU 加速预览、大文件流式处理、内存监控、启动预热、插件热重载、断点续传、工作区自动保存、OCR 多语言增强（10 种语言 + 竖排文字）。

**下一阶段（v1.2）**：稳定性与生态扩展 — 更多预设格式支持、插件 SDK 完善、云端同步预览、社区贡献者工具链。
