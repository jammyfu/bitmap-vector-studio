...
**当前阶段（v0.4.0）**：生态与集成 — 插件系统、Web API、Docker 容器化、配置管理、一键安装脚本、包管理器模板。

**下一阶段（v0.5）**：AI 辅助方向 — AI 辅助重绘、文字/Logo OCR、局部重描摹、实时预览。

**长期目标（v1.0）**：Tauri 桌面端、拖拽队列、原生文件菜单、跨平台打包、自动更新机制。
